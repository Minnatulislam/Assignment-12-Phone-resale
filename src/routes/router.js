...
export const router = createBrowserRouter([
  {
    ...
    children: [
      { path: '/', element: <Home></Home> },
      {
        ...
        loader: ({ params }) => fetch(` https://server-site-12.vercel.app/sellerProducts/${params.id}`)
      },
...

      {
        ...
        loader: ({ params }) => fetch(` https://server-site-12.vercel.app/categories/${params.id}`)
...

  {
    path: '/deshboard', element: <DeshboardLayout></DeshboardLayout>, children: [
...

      {
        ...
        loader: ({ params }) => fetch(` https://server-site-12.vercel.app/bookings/${params.id}`)
      }
    ]
  }
])